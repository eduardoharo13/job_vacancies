...
if df_analysis is not None and selected_col is not None:
    ...
    if cross_col and selected_col in MULTI_LABEL_COLUMNS:
        ...
        cross_tab_percentage_mode = st.radio(
            ...
            help="Defines whether 100% represents the sum of all labels found in the group or the total count of unique rows/observations that contributed to the group."
        )
    else:
